...
//     for(let i = 0; i < arr.length; i++){
//         if(arr[i].color === 'purple'){
//             return console.log(`The fruit with index ${arr.indexOf(arr[i])} is grape`)
//         }
//     }
// }
...
const nameParameter = (parameter1, parameter2) => console.log(`The first parameter is ${parameter1}. The second parameter is ${parameter2}`)
nameParameter('sink', 'tub')
...
function printGreeting(fullName){
    console.log(`Hello, my full name is ${fullName}`)
}

greeting('Megan', 'Turley', printGreeting)
...
function pricesPlusTax(arr, callback){
    for(let i = 0; i < arr.length; i++){
        const preTaxPrice = arr[i]
        const totalPrice = preTaxPrice * 1.2
