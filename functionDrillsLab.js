...
//   }
// }
// console.log(compareNums(18, 18))

const compareNums = (num1, num2) => (num1 > num2 ? num1 : num2)

console.log(compareNums(16, 28))
...
const nameGreeting = nameCheck('Dillon')
...
const thatsOdd = (a) => {
  return a % 2 === 0 ? "That's not odd!" : 'That is odd indeed!'
}
const oddChecker = thatsOdd(16)
...
console.log(bestMovie("Across The Universe"))
...
const check = emailCheck('turleymegan5gmail.com')
console.log(check)
////////////////// PROBLEM 19 ////////////////////
/*
...
function frogBank(money){
  const frogCost = 3
  frogCount = money / frogCost
  return frogCount
}
totalFrogs = frogBank(100)
...
function frogBank2(money2){
  const frogCost2 = 3
  frogCount2 = Math.floor(money2 / frogCost2)
  return frogCount2
}
totalFrogs2 = frogBank2(100)
